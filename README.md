...
Este repositório funciona como a página geral do meu portfólio em **Análise de Dados**, reunindo projectos pessoais desenvolvidos no âmbito da aprendizagem prática e interesse pela área.

Os projectos apresentados envolvem:
- Limpeza e tratamento de dados
- Análise exploratória
- Visualização de dados
- Modelos preditivos e interpretação de resultados
